...
/obj/structure/machinery/cm_vending/gear/synth
	...
	vendor_role = list(JOB_SYNTH, JOB_MS_SYNTH, JOB_SYNTH_SURVIVOR, JOB_UPP_SUPPORT_SYNTH, JOB_CMB_SYN, JOB_CMB_RSYN, JOB_PMC_SYNTH)
...
GLOBAL_LIST_INIT(cm_vending_clothing_synth, list(
		...
		list("Hazard Vest(Black)", 0, /obj/item/clothing/suit/storage/hazardvest/black, MARINE_CAN_BUY_ARMOR, VENDOR_ITEM_REGULAR),
		list("Synthetic's Snow Suit", 0, /obj/item/clothing/suit/storage/snow_suit/synth, MARINE_CAN_BUY_ARMOR, VENDOR_ITEM_REGULAR),
		list("USCM Service Jacket", 0, /obj/item/clothing/suit/storage/jacket/marine/service, MARINE_CAN_BUY_ARMOR, VENDOR_ITEM_REGULAR),
		list("USCM MP Service Jacket", 0, /obj/item/clothing/suit/storage/jacket/marine/service/mp, MARINE_CAN_BUY_ARMOR, VENDOR_ITEM_REGULAR),
		list("Windbreaker, Brown", 0, /obj/item/clothing/suit/storage/windbreaker/windbreaker_brown, MARINE_CAN_BUY_ARMOR, VENDOR_ITEM_REGULAR),
		list("Windbreaker, Grey", 0, /obj/item/clothing/suit/storage/windbreaker/windbreaker_gray, MARINE_CAN_BUY_ARMOR, VENDOR_ITEM_REGULAR),
		list("Windbreaker, Green", 0, /obj/item/clothing/suit/storage/windbreaker/windbreaker_green, MARINE_CAN_BUY_ARMOR, VENDOR_ITEM_REGULAR),
		list("Windbreaker, First Responder", 0, /obj/item/clothing/suit/storage/windbreaker/windbreaker_fr, MARINE_CAN_BUY_ARMOR, VENDOR_ITEM_REGULAR),
		list("Windbreaker, Exploration", 0, /obj/item/clothing/suit/storage/windbreaker/windbreaker_covenant, MARINE_CAN_BUY_ARMOR, VENDOR_ITEM_REGULAR),
...
GLOBAL_LIST_INIT(cm_vending_synth_tools, list(
	...
	list("Surgical Drop Pouch (Blue)", 15, /obj/item/clothing/accessory/storage/surg_vest/drop_blue, MARINE_CAN_BUY_ACCESSORY, VENDOR_ITEM_REGULAR),
	list("Surgical Drop Pouch (Black)", 15, /obj/item/clothing/accessory/storage/surg_vest/drop_black, MARINE_CAN_BUY_ACCESSORY, VENDOR_ITEM_REGULAR),
