...
GLOBAL_LIST_INIT(ROLES_MS, list(JOB_MS_GC, JOB_MS_PC, JOB_MS_SL, JOB_MS_ENGINEER, JOB_MS_MEDIC, JOB_MS_SMARTGUNNER, JOB_MS_RFM, JOB_MS_INTEL, JOB_MS_PILOT, JOB_MS_CREWMAN, JOB_MS_SYNTH, JOB_COMBAT_REPORTER, JOB_CHIEF_POLICE, JOB_MAINT_TECH, JOB_MESS_SERGEANT, JOB_CHIEF_REQUISITION, JOB_CARGO_TECH))
...
GLOBAL_LIST_INIT(ROLES_BLACKGOLD, GLOB.ROLES_MS + GLOB.ROLES_POLICE + ROLES_ENGINEERING + GLOB.ROLES_MEDICAL + GLOB.ROLES_REQUISITION + GLOB.ROLES_MISC - ROLES_WO - ROLES_MARINES)
...
#define FACTION_PINKERTON "Pinkerton"
