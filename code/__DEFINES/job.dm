...
#define JOB_PKT_MED "Pinkerton Field Paramedic"
...
#define JOB_FORECON_SMARTGUNNER "USCM FORECON Squad Support rifleman"
#define JOB_FORECON_MEDIC "USCM FORECON Squad Corpsman"
#define JOB_FORECON_IO "USCM FORECON Inteligence Officer"
