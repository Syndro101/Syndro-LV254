...
/obj/structure/machinery/cm_vending/sorted/cargo_guns/populate_product_list(scale)
	listed_products = list(
		...
		list("M68 Thermal Cloak", floor(scale * 1), /obj/item/storage/backpack/marine/satchel/scout_cloak, VENDOR_ITEM_REGULAR),
		...
		list("M40 HEDP Grenade Box", 4, /obj/item/storage/box/nade_box, VENDOR_ITEM_REGULAR),
...
/obj/structure/machinery/cm_vending/sorted/cargo_ammo/populate_product_list(scale)
	listed_products = list(
		...
		list("M10 AP magazine (10x20mm)", floor(scale * 10), /obj/item/ammo_magazine/pistol/m10/ap, VENDOR_ITEM_REGULAR),
		...
		list("Magazine Box (Ext M4RA x 16)", 0, /obj/item/ammo_box/magazine/m4ra/ext, VENDOR_ITEM_REGULAR),
...
/obj/structure/machinery/cm_vending/sorted/uniform_supply
	...
	listed_products = list(
		...
		list("BACKPACKS", -1, null, null),
		list("IMP Backpack", 20, /obj/item/storage/backpack/marine, VENDOR_ITEM_REGULAR),
		list("Lightweight IMP Backpack", 20, /obj/item/storage/backpack/marine/satchel/squad, VENDOR_ITEM_REGULAR),
		...
		list("M3-L Pattern Marine Armor", 20, /obj/item/clothing/suit/storage/marine/light, VENDOR_ITEM_REGULAR),
		list("M3 Pattern Marine Armor", 20, /obj/item/clothing/suit/storage/marine, VENDOR_ITEM_REGULAR),
		list("M3-H Pattern Marine Armor", 10, /obj/item/clothing/suit/storage/marine/heavy, VENDOR_ITEM_REGULAR),
		...
		list("Gas Mask", 25, /obj/item/clothing/mask/gas, VENDOR_ITEM_REGULAR),
		list("Heat Absorbent Coif", 25, /obj/item/clothing/mask/rebreather/scarf, VENDOR_ITEM_REGULAR),
		list("USCM Poncho", 25, /obj/item/clothing/accessory/poncho, VENDOR_ITEM_REGULAR),
		list("USCM Trench Coat (green)", 25, /obj/item/clothing/suit/storage/jacket/marine/service/trenchcoat_grn, VENDOR_ITEM_REGULAR),
		list("USCM Trench Coat (tan)", 25, /obj/item/clothing/suit/storage/jacket/marine/service/trenchcoat_tan, VENDOR_ITEM_REGULAR),
		list("USCM Trench Coat (gray)", 25, /obj/item/clothing/suit/storage/jacket/marine/service/trenchcoat_blk, VENDOR_ITEM_REGULAR),

		list("MISCELLANEOUS", -1, null, null),
		list("Earplugs", 30, /obj/item/clothing/ears/earmuffs/earplugs, VENDOR_ITEM_REGULAR),
		...
		list("M5 Radio & Camera Gear", 1, /obj/item/device/radio/headset/almayer/marine/overwatch_camera, VENDOR_ITEM_REGULAR),
		)
...
/obj/structure/machinery/cm_vending/sorted/cargo_guns/squad_prep/training/populate_product_list(scale)
	listed_products = list(
		...
		list("MK221 tactical shotgun", floor(scale * 15), /obj/item/weapon/gun/shotgun/combat, VENDOR_ITEM_REGULAR),
		list("M39 Submachine Gun", floor(scale * 30), /obj/item/weapon/gun/smg/m39, VENDOR_ITEM_REGULAR),
		list("M41A Pulse Rifle MK1", floor(scale * 30), /obj/item/weapon/gun/rifle/m41aMK1, VENDOR_ITEM_RECOMMENDED),
