...
/proc/get_sfx(sound)
	if(istext(sound))
		switch(sound)
			...
			if("zipper")
				sound = pick('sound/items/zip.ogg')
			// Weapons/bullets
			if("shell_load")
			...
			if("gun_pulse_smg")
				sound = pick('sound/weapons/gun_m39_1.mp3','sound/weapons/gun_m39_2.mp3','sound/weapons/gun_m39_3.mp3')
			if("gun_pulse")
				sound = pick('sound/weapons/gun_m41a_1.mp3','sound/weapons/gun_m41a_2.mp3','sound/weapons/gun_m41a_3.mp3','sound/weapons/gun_m41a_4.mp3','sound/weapons/gun_m41a_5.mp3')
			if("gun_pulse_alt")
			...
			if("gun_smartgun")
				sound = pick('sound/weapons/gun_smartgun1.mp3', 'sound/weapons/gun_smartgun2.mp3', 'sound/weapons/gun_smartgun3.mp3', 'sound/weapons/gun_smartgun4.mp3')
			if("gun_smartgun_rattle")
				sound = pick('sound/weapons/gun_smartgun1_rattle.mp3', 'sound/weapons/gun_smartgun2_rattle.mp3', 'sound/weapons/gun_smartgun3_rattle.mp3', 'sound/weapons/gun_smartgun4_rattle.mp3')
			if("gun_jam_rack")
			...
			if("smartgun_knockdown")
				sound = pick('sound/weapons/smartgun_knockdown.ogg', 'sound/weapons/smartgun_knockdown_2.ogg', 'sound/weapons/smartgun_knockdown_3.ogg', 'sound/weapons/smartgun_move.mp3', 'sound/weapons/smartgun_move2.mp3',)
