/obj/item/hardpoint/support/longstreet/tank_turret
	...
	ammo = new /obj/item/ammo_magazine/hardpoint/secondary/longstreet/smoke
	max_clips = 2
	...
	accepted_hardpoints = list(
		...
		/obj/item/hardpoint/secondary/longstreet/m56cupola,
...
/obj/item/hardpoint/support/longstreet/tank_turret/update_icon()
	var/broken = (health <= 0)
...
/obj/item/hardpoint/support/longstreet/tank_turret/get_icon_image(x_offset, y_offset, new_dir)
...
/obj/item/hardpoint/support/longstreet/tank_turret/attack_hand(mob/user)
	return

/obj/item/hardpoint/support/longstreet/tank_turret/attackby(obj/item/I, mob/user)
...
/obj/item/hardpoint/support/longstreet/tank_turret/get_tgui_info()
	var/list/data = list()
...
/obj/item/hardpoint/support/longstreet/tank_turret/proc/toggle_gyro(mob/user)
	if(health <= 0)
...
/obj/item/hardpoint/support/longstreet/tank_turret/proc/user_rotation(mob/user, deg)
...
/obj/item/hardpoint/support/longstreet/tank_turret/rotate(deg, override_gyro = FALSE)
	if(gyro && !override_gyro)
		return

	..(deg)

/obj/item/hardpoint/support/longstreet/tank_turret/try_fire(atom/target, mob/living/user, params)
	var/turf/L
	var/turf/R
	switch(owner.dir)
		if(NORTH)
