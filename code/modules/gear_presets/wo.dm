...
/datum/equipment_preset/wo/commander/load_gear(mob/living/carbon/human/new_human)
	...
	//jacket
	new_human.equip_to_slot_or_del(new /obj/item/clothing/suit/storage/marine/officer/commander(new_human), WEAR_JACKET)
...
/datum/equipment_preset/wo/xo/load_gear(mob/living/carbon/human/new_human)
	...
	//jacket
	new_human.equip_to_slot_or_del(new /obj/item/clothing/suit/storage/marine/officer(new_human), WEAR_JACKET)
	//waist
