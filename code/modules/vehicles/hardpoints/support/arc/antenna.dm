...
/obj/item/hardpoint/support/arc/antenna/proc/deploy_antenna()
	set waitfor = FALSE
...
/obj/item/hardpoint/support/arc/antenna/proc/retract_antenna()
	set waitfor = FALSE
...
/obj/item/hardpoint/support/arc/antenna/get_icon_image(x_offset, y_offset, new_dir)
...
/obj/item/hardpoint/support/arc/antenna/can_be_removed(mob/remover)
	var/obj/vehicle/multitile/arc/arc_owner = owner
	if(!istype(arc_owner))
		return TRUE
...
/obj/item/hardpoint/support/arc/antenna/on_destroy()
	var/obj/vehicle/multitile/arc/arc_owner = owner
	if(!istype(arc_owner))
		return
