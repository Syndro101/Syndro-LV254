...
/obj/item/hardpoint/primary/arc/sentry
	...
	ammo = new /obj/item/ammo_magazine/hardpoint/primary/arc/sentry
	max_clips = 2

	allowed_ammo_types = list(
		/obj/item/ammo_magazine/hardpoint/primary/arc/sentry,
		/obj/item/ammo_magazine/hardpoint/primary/arc/sentry/he
	)
...
/obj/item/hardpoint/primary/arc/sentry/on_install(obj/vehicle/multitile/vehicle)
	. = ..()
...
/obj/item/hardpoint/primary/arc/sentry/on_uninstall(obj/vehicle/multitile/vehicle)
	. = ..()
	UnregisterSignal(owner, COMSIG_ARC_ANTENNA_TOGGLED)
	STOP_PROCESSING(SSfastobj, src)

/obj/item/hardpoint/primary/arc/sentry/Destroy()
	STOP_PROCESSING(SSfastobj, src)
	sentry_target = null
	return ..()

/obj/item/hardpoint/primary/arc/sentry/proc/toggle_processing()
	SIGNAL_HANDLER
	if(!owner)
		return
...
/obj/item/hardpoint/primary/arc/sentry/process()
...
/obj/item/hardpoint/primary/arc/sentry/set_bullet_traits()
	LAZYADD(traits_to_give, list(
		BULLET_TRAIT_ENTRY(/datum/element/bullet_trait_iff, faction_group)
	))

/obj/item/hardpoint/primary/arc/sentry/fire_wrapper(atom/target, mob/living/user, params)
	if(!target)
		target = src.target
	if(!target)
		return NONE
...
/obj/item/hardpoint/primary/arc/sentry/start_fire(datum/source, atom/object, turf/location, control, params)
	if(QDELETED(object))
		return
...
/obj/item/hardpoint/primary/arc/sentry/proc/get_target(atom/movable/new_target)
...
/obj/item/hardpoint/primary/arc/sentry/proc/purge_target(mob/target)
	if(target == sentry_target)
		sentry_target = null
	targets.Remove(target)

/obj/item/hardpoint/primary/arc/sentry/can_be_removed(mob/remover)
