...
/obj/structure/machinery/cm_vending/sorted/vehicle_supply/populate_product_list(scale)
	listed_products = list(
		...
		list("M41A Pulse Rifle MK1", round(scale * 3), /obj/item/weapon/gun/rifle/m41aMK1, VENDOR_ITEM_REGULAR),
...
/obj/structure/machinery/cm_vending/sorted/vehicle_supply/tent/populate_product_list(scale)
	listed_products = list(
		...
		list("M3-L Pattern Light Marine Armor", 0, /obj/item/clothing/suit/storage/marine/light, VENDOR_ITEM_REGULAR),
		list("M3 Pattern Marine Armor", 0, /obj/item/clothing/suit/storage/marine, VENDOR_ITEM_REGULAR),
		list("M3-H Pattern Heavy Marine Armor", 0, /obj/item/clothing/suit/storage/marine/heavy, VENDOR_ITEM_REGULAR),
